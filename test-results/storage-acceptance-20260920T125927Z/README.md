...
- `passed-results.tar.xz`：之前已验证的成功证据，原包未改。
...
```bash
mkdir -p /tmp/storage-acceptance-20260920T125927Z-inspect
tar -xJf passed-results.tar.xz -C /tmp/storage-acceptance-20260920T125927Z-inspect
tar -xJf remaining-evidence.tar.xz -C /tmp/storage-acceptance-20260920T125927Z-inspect
```
