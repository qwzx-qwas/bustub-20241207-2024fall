...
TEST(DiskSchedulerTest, ScheduleWriteReadPageTest) {
  ...
  disk_scheduler->Schedule({/*is_write=*/true, /*is_delete=*/false, data, /*page_id=*/0, std::move(promise1)});
  disk_scheduler->Schedule({/*is_write=*/false, /*is_delete=*/false, buf, /*page_id=*/0, std::move(promise2)});
